<template>
  <section class="portfolio bg-gray-700 min-h-screen pt-16 pb-16">
    <div class="container mx-auto px-4">
      ...
      <h3 class="font-semibold mb-4 text-gray-200 text-xl">
        Here some of <span class="text-green-400">my result</span> :
      </h3>
      <div class="list">
        <sequential-entrance>
